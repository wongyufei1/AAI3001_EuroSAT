...
from modules.EuroSAT_RGB_dataset import load_data, EuroSatRgbDatasetMultiLabel, decode_labels
...
def run(data_path):
    ...
    datasets = {
        "valid": EuroSatRgbDatasetMultiLabel(valid_split, indices_to_labels, data_transform),
        "test": EuroSatRgbDatasetMultiLabel(test_split, indices_to_labels, data_transform)
    }
    ...
    euro_sat_rgb_model = EuroSatRgbModelMultiLabel(model=model,
                                         device=device,
                                         n_classes=n_classes,
                                         weights=weights)
